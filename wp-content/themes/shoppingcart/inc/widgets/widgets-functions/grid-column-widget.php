...
class Shoppingcart_product_grid_column_Widget extends WP_Widget {
	...
	function form($instance) {
		...
		<p>
			...
			<?php _e( 'Number of Post:', 'shoppingcart' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php _e( 'Select Product Category', 'shoppingcart' ); ?>:</label>
			...
			<br>
			<span><?php _e('Product Category will display only  when Category is selected from Options dropdown. ','shoppingcart'); ?></span>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'product_type' ); ?>"><?php _e( 'Options:', 'shoppingcart' ); ?></label>
			<select id="<?php echo $this->get_field_id( 'product_type' ); ?>" name="<?php echo $this->get_field_name( 'product_type' ); ?>">
				<option value="latest" <?php selected( $instance['product_type'], 'latest'); ?>><?php _e( 'All Latest', 'shoppingcart' ); ?></option>
				<option value="category" <?php selected( $instance['product_type'], 'category'); ?>><?php _e( 'Category', 'shoppingcart' ); ?></option>
			</select>
		</p>
