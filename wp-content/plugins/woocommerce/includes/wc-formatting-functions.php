...
function wc_price( $price, $args = array() ) {
	...
	$formatted_price = ( $negative ? '-' : '' ) . sprintf($price, $args['price_format'], '<span class="woocommerce-Price-currencySymbol">' . get_woocommerce_currency_symbol( $args['currency'] ) . '</span>' );
